...
//for Unity XR, you only need to use this if you are using Stereo Rendering Mode - Single Pass Instanced
...
public class SteamVRFrustumAdjustXRSinglePass : MonoBehaviour
{
